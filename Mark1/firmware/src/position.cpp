...
void setup() {
...
#ifdef ENABLE_MOTOR3
    myWire3.begin();
    myWire3.setClock(I2C_CLOCK_HZ);   // closed loop needs fast sensor reads for a clean velocity estimate
    ...
    motor3.voltage_limit            = VOLTAGE_LIMIT;   // bring-up: lower current -> less PWM EMI on I2C4
